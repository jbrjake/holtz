...
Users can add custom lenses by appending new sections following the same five-field format (Focus, Scope, Audit priorities, Failure modes, Entry point). Any `## heading` in this file with the four required fields is treated as a lens.
